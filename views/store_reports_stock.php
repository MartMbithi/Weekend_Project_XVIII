                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h4 class="nk-block-title fw-normal">Inventory</h4>
                                                <p>
                                        ...
                                        <div class="toggle-wrap nk-block-tools-toggle">
                                            ...
                                            <div class="toggle-expand-content" data-content="pageMenu">
                                                <ul class="nk-block-tools g-3">
                                                    <li><a href="store_system_inventory_pdf_dump?view=<?php echo $_GET['view']; ?>" class="btn btn-primary"><em class="icon ni ni-file-docs"></em><span>Export To PDF</span></a></li>
                                                    <li><a href="store_system_inventory_xls_dump?view=<?php echo $_GET['view']; ?>" class="btn btn-primary"><em class="icon ni ni-grid-add-fill-c"></em><span>Export To Excel</span></a></li>
                                                </ul>
                                            </div>
                                        </div><!-- .toggle-wrap -->
                                    </div><!-- .nk-block-head-content -->
