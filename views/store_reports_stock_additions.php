                                ...
                                <div class="nk-block-between-md g-3">
                                    <div class="nk-block-head-content">
                                        <div class="align-center flex-wrap pb-2 gx-4 gy-3">
                                            <div>
                                                <h4 class="nk-block-title fw-normal">Stock Addition Reports</h4>
                                                <p>
                            ...
                            ?>
                                <div class="row">
                                    <div class="card mb-3 col-md-12 border border-success">
                                        <div class="card-body">
                                            <div class="text-right">
                                                <a href="main_dashboard_system_stock_addition_pdf_dump?store=<?php echo $store_id; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>" class="btn btn-primary"><em class="icon ni ni-file-docs"></em><span>Export To PDF</span></a>
                                                <a href="main_dashboard_system_stock_addition_xls_dump?store=<?php echo $store_id; ?>&start=<?php echo $start; ?>&end=<?php echo $end; ?>" class="btn btn-primary"><em class="icon ni ni-grid-add-fill-c"></em><span>Export To Excel</span></a>
                                            </div>
                                            <hr>
