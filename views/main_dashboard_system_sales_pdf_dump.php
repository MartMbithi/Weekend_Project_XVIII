    ...
    if ($report_type == 'Summarized Report') {
        $html =
                ...
                <!DOCTYPE html>
                    <html>
                        ...
                        <body style="margin:1px;">
                            <div class="footer">
                                <hr>
                                <i><b>Report Generated On ' .
            date('d M Y') .
            ', Dasati medical clinic POS. Powered By Devlan Solutions LTD ~ devlan.co.ke </b><i>
                            </div>
            ...
            ' 
                                ...
                                <h5>Summarized Sales Report From ' .
                ...
                $html .=
                    '
                                                    <tr>
                                                        ...
                                                        <td><b>' .
                    'Ksh ' .
                    number_format($cumulative_income, 2) .
                    '</b></td>
                                                    </tr>
                                            </tbody>
                                        </table>
        ...
        $dompdf->render();
        $dompdf->stream(
            'Summarized Sales Report From ' . $start . ' To ' . $end,
            ['Attachment' => 1]
        );
        $options = $dompdf->getOptions();
        $options->setDefaultFont('');
        $dompdf->setOptions($options);
    } /* Show More Composite Reports Too */ else {
        $html =
            '
                <!DOCTYPE html>
                    <html>
                        ...
                        <body style="margin:1px;">
                            <div class="footer">
                                ...
                                <i><b>Report Generated On ' .
            date('d M Y') .
            ', NativeBeecare POS. Powered By Devlan Solutions LTD ~ devlan.co.ke </b><i>
                            </div>
            ...
            ' 
                                ...
                                <hr style="width:100%" , color=black>
                                <h5>Composite Sales Report From ' .
            date('M d Y', strtotime($start)) .
            ' To ' .
            date('M d Y', strtotime($end)) .
            ' </h5>
                ...
                while ($sales = $res->fetch_object()) {
                    ...
                    $html .=
                        ...
                        '</td>
                                                            <td>' .
                        'Ksh ' .
                        number_format($sales->product_sale_price, 2) .
                        '</td>
                                                            <td>' .
                        'Ksh ' .
                        number_format($sales->sale_discount, 2) .
                        '</td>
                                                            <td>' .
                        'Ksh ' .
        ...
        $dompdf->render();
        $dompdf->stream(
            'Composite Sales Report From ' . $start . ' To ' . $end,
            ['Attachment' => 1]
        );
        $options = $dompdf->getOptions();
        $options->setDefaultFont('');
