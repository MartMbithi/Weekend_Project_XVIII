...
if ($log_type == 'All Logs') {
    ...
    if ($query->num_rows > 0) {
        ...
        while ($row = $query->fetch_assoc()) {
            $log_datetime = new DateTime($row['log_created_at'], new DateTimeZone('UTC'));
            ...
            $lineData = array($row['user_name'] . ' ' . $row['user_email'], $row['log_ip_address'], $formatted_time, $row['log_details']);
