                                ...
                                <div class="dropdown-body">
                                    <div class="nk-notification">
                                        ...
                                        while ($hold_sales = $res->fetch_object()) {
                                            $hold_sale_time = new DateTime(
                                                $hold_sales->hold_sale_time,
                                                new DateTimeZone('UTC')
                                            );
                                            $offset_timezone = new DateTimeZone($timezone_offset);
                                            $hold_sale_time->setTimezone($offset_timezone);
                                            $formatted_time = $hold_sale_time->format('d M Y g:ia');
                                            /* Load This Hidden */
                                        ...
                                        ?>
                                            <div class="nk-notification-item dropdown-inner">
                                                ...
                                                <div class="nk-notification-content">
                                                    ...
                                                    <div class="nk-notification-time"><?php echo $formatted_time; ?></div>
